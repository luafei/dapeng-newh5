  ...
  <div class="home">
    ...
    <div class="content">
      <div class="trafficOperation">
        ...
        <div class="center">
          <img src="@/assets/images/traffic.svg" alt="" />
          <p>通行量</p>
        </div>
        <div class="footer">
      ...
      <div class="governServices">
        <div class="header" @click="goDetail(2)">
          <span>政务服务</span>
          <img src="@/assets/images/right.png" alt="" />
        </div>
        <div class="center">
          <div>
            <p>
              <img src="@/assets/images/yewu.svg" />
              <span>{{ govern.byyw }}</span>
            </p>
            <p>本月总体业务量</p>
          </div>
          <div>
          ...
          <div>
            <p>
              <img src="@/assets/images/ywmp.svg" />
              <span>{{ govern.fastApprovePercent }}</span>
            </p>
            <p>秒批业务占比</p>
          </div>
          <div>
            <p>
              <img src="@/assets/images/bnbj.svg" />
              <span>{{ govern.bnbj }}</span>
            </p>
            <p>本年办结率</p>
          </div>
        </div>
      ...
      <div class="ecologicalIndicators">
        ...
        <div class="center">
          <div>
            <img src="@/assets/images/ecological_yezi.svg" />
            <p>空气质量</p>
          </div>
          <div>
            <p>优</p>
      ...
      <div class="tourismCulture">
        ...
        <div class="center">
          <div class="item">
            <img src="@/assets/images/tourism_sum.svg" />
            <p><span>766.71</span>万人次</p>
            <p>接待总次数</p>
          </div>
          <div class="lin"></div>
          <div class="item">
            <img src="@/assets/images/tourism_income.svg" />
      ...
      <div class="dataSharing">
        ...
        <div class="center">
          <div>
            <p>
              <img src="@/assets/images/dataSharing_system.svg" />
              <span>52</span>个
            </p>
            <p>数据湖系统</p>
          </div>
          <div>
            <p>
              <img src="@/assets/images/dataSharing_sum.svg" />
              <span>19.2</span>亿
            </p>
            <p>数据湖数据量</p>
          </div>
          <div>
            <p>
              <img src="@/assets/images/dataSharing_app.svg" />
              <span>19</span>个
            </p>
            <p>数据共享应用</p>
          </div>
          <div>
            <p>
              <img src="@/assets/images/dataSharing_share.png" />
              <span>16.4</span>亿
            </p>
            <p>数据共享数据量</p>
          </div>
      ...
      <div class="smartEmergency">
        ...
        <div class="center">
          <div>
            <p>
              <img src="@/assets/images/smartEmergency_big.svg" />
            </p>
            <p>重大危险源</p>
          </div>
          <div>
            <p>
              <img src="@/assets/images/smartEmergency_yujing.svg" />
            </p>
            <p>预警</p>
          </div>
          <div>
            <p>
              <img src="@/assets/images/smartEmergency_san.svg" />
            </p>
            <p>三防</p>
          </div>
          <div>
            <p>
              <img src="@/assets/images/smartEmergency_qixiang.svg" />
            </p>
            <p>气象</p>
          </div>
        </div>
      ...
      <div class="smartMedical">
        ...
        <div class="center">
          <p>
            <img src="@/assets/images/smartMedical_chae.svg" />
            <span>医疗收支差额</span>
          </p>
          <p>
            <img src="@/assets/images/smartMedical_sum.svg" />
            <span>参保人数</span>
          </p>
          <p>
            <img src="@/assets/images/smartMedical_jieyu.svg" />
            <span>基金累计结余</span>
          </p>
        </div>
      </div>
      <div class="smartHousing">
        <div class="header">
          <span>智慧住建</span>
          <img src="@/assets/images/right.png" />
        </div>
        <div class="center">
          <div class="item">
            <p><span></span>个</p>
            <p><img src="@/assets/images/smartHousing_sum.svg" />项目总数</p>
          </div>
          <span class="lin"></span>
          <div class="item">
            <p><span></span>人</p>
            <p>
              <img src="@/assets/images/smartHousing_person.svg" />在场总人数
            </p>
          </div>
        </div>
        <div class="footer">
          <div>
            <p>
              <img src="@/assets/images/smartHousing_keng.svg" />
              <span>个</span>
            </p>
            <p>深基坑</p>
          </div>
          <div>
            <p>
              <img src="@/assets/images/smartHousing_engine.svg" />
              <span>个</span>
            </p>
            <p>暗挖工程</p>
          </div>
          <div>
            <p>
              <img src="@/assets/images/smartHousing_jixie.svg" />
              <span>个</span>
            </p>
            <p>起重机械</p>
          </div>
      ...
      <div class="gis">
        ...
        <div class="center">
          <div class="item">
            <div>
              <img src="@/assets/images/gis_map.png" alt="" />
            </div>
            <div>96</div>
            <div>地图服务</div>
          </div>
          ...
          <div class="item">
            <div class="title">
              <img src="@/assets/images/gis_function.png" alt="" />
            </div>
            <div>253</div>
            <div>功能服务</div>
          </div>
          ...
          <div class="item">
            <div class="title">
              <img src="@/assets/images/gis_apply.png" alt="" />
            </div>
            <div>3</div>
            <div>已应用系统数</div>
          </div>
      ...
      <div class="smartCity">
        ...
        <div class="center">
          <div class="item">
            <div class="title">
              <img src="@/assets/images/smartCity_chengguan.svg" />
              <p>智慧城管</p>
            </div>
      ...
      <div class="commercialSubject">
        ...
        <div class="top">
          <div class="tt">
            <img src="@/assets/images/commercialSubject_zhu.svg" alt="" />
            <span>商事主体数</span>
            <span></span>
            <span>家</span>
          </div>
        ...
        <div class="center">
          <div class="item">
            <p>家</p>
            <p>
              <img src="@/assets/images/commercialSubject_qiye.svg" /><span
                >企业数量</span
              >
            </p>
          </div>
          ...
          <div class="item">
            <p>家</p>
            <p>
              <img src="@/assets/images/commercialSubject_shanghu.svg" /><span
                >个体商户数量</span
              >
            </p>
          </div>
...
export default {
  ...
  methods: {
    goDetail(id) {
      ...
      id == 4 && this.$router.push("hazardousVehicle");
    },
    ...
    initGovernService() {
      ...
      gettarget().then((res) => {
        if (res.data.data) {
          self.govern.fastApprovePercent =
            res.data.data.fastApprovePercent * 100 + "%";
          self.govern.hp =
            (1 - res.data.data.negativeCommentPercent) * 100 + "%";
        }
      });
    ...
    iframeProcessContent() {
      ...
      iFrame.onload = function () {
        //iframe加载完立即发送一条消息
        iFrame.contentWindow.postMessage(document.documentElement.getBoundingClientRect().width, "*");
      };
...
$trafficHeader: #a257c9;
$governHeader: #4b6bc6;
$dumpTruckHeader: #3092ed;
...
$smartMedicalHeader: #23b471;
$smartHousingHeader: #0000bf;
$gisHeader: #545efb;
$smartCityHeader: #70b503;
$wisdomSutraHeader: #ff7e3d;
...
.home {
  ...
  .content {
    ...
    .dataSharing {
      @include module;
      .header {
        @include head($dataSharingHeader);
      }
      .center {
        display: flex;
        flex-wrap: wrap;
    ...
    .smartMedical {
      @include module;
      .header {
        @include head($smartMedicalHeader);
      }
      .center {
        img {
          width: 22px;
    ...
    .smartHousing {
      @include module;
      .header {
        @include head($smartHousingHeader);
      }
      .center {
        height: 50px;
        display: flex;
    ...
    .wisdomSutra {
      @include module;
      .header {
        @include head($wisdomSutraHeader);
      }
      .top {
        width: 100%;
        height: 30px;
    ...
    .commercialSubject {
      @include module;
      .header {
        @include head($commercialSubjectHeader);
      }
      .top {
        display: flex;
        align-items: center;
